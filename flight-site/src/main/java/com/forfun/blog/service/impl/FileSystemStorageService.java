...
import com.forfun.blog.exception.StorageException;
import com.forfun.blog.exception.StorageFileNotFoundException;
    ...
    public void store(MultipartFile file, String prefix) {
        ...
        try {
            ...
            try (InputStream is = file.getInputStream()) {
                Files.copy(is, rootLocation.resolve(prefix + filename),
